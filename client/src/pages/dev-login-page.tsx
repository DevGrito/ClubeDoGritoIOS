...
import girlImage from "@assets/CAPA DEV_1763572613505.png";
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success && response.developer) {
        ...
        // Redirecionar baseado no tipo do desenvolvedor
        if (tipo === "admin") {
          setLocation("/dev"); // Admin começa em /dev mas pode navegar para /dev/marketing
