...
import { ShoppingBag, Scissors, BarChart3, Save, Shield, Loader2 } from "lucide-react";
...
export default function CoordenadorNegociosPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900">
      <div className="bg-slate-900 border-b border-slate-700 px-4 py-4 md:px-6 border-l-4 border-l-amber-500">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Negócios Sociais</h1>
      ...
      <div className="container mx-auto px-4 py-6 md:px-6 max-w-2xl space-y-6">
        ...
        <Card className="bg-slate-800 border-l-4 border-l-yellow-400 border-slate-700">
          ...
          <CardContent className="space-y-3">
            <FieldRow label="Clientes Atendidos"           field="outletClientesAtendidos" form={form} setForm={setForm} readOnly={isAnual} />
            <FieldRow label="Itens Vendidos"               field="outletPecasVendidas"     form={form} setForm={setForm} readOnly={isAnual} />
            <FieldRow label="Lives Realizadas"             field="outletLivesRealizadas"   form={form} setForm={setForm} readOnly={isAnual} />
            <FieldRow label="Total de Vendas (R$)"         field="outletValorVendas"       form={form} setForm={setForm} readOnly={isAnual} />
          </CardContent>
        </Card>
        ...
        <Card className="bg-slate-800 border-l-4 border-l-yellow-400 border-slate-700">
          ...
          <CardContent className="space-y-3">
            <FieldRow label="Clientes Atendidos"  field="griffteClientesAtendidos"   form={form} setForm={setForm} readOnly={isAnual} />
            <FieldRow label="Pedidos Entregues"   field="grifftePedidosEntregues"    form={form} setForm={setForm} readOnly={isAnual} />
            <FieldRow label="Peças Produzidas"    field="grifftePecasConfeccionadas" form={form} setForm={setForm} readOnly={isAnual} />
            <FieldRow label="Total de Vendas (R$)" field="griffteValorVendas"        form={form} setForm={setForm} readOnly={isAnual} />
          </CardContent>
        </Card>
