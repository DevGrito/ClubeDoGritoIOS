      ...
      <CardContent className="space-y-6">
        ...
        {evidenceType !== 'link' || referralData.missaoCompletada ? (
          ...
          <div className="text-center py-4">
            ...
            {referralData.referralsNecessarios > 0 && (
              <div className="mt-3 p-3 bg-blue-50 rounded-lg">
                <p className="text-blue-700 font-semibold text-lg">
                  {referralData.cadastrosCompletos} / {referralData.referralsNecessarios} amigos cadastrados
                </p>
                <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                  <div 
                    className="bg-blue-600 h-2 rounded-full transition-all duration-500" 
                    style={{ width: `${Math.min((referralData.cadastrosCompletos / referralData.referralsNecessarios) * 100, 100)}%` }}
                  />
                </div>
                {referralData.cadastrosCompletos < referralData.referralsNecessarios && (
                  <p className="text-sm text-blue-600 mt-1">
                    Faltam {referralData.referralsNecessarios - referralData.cadastrosCompletos} para completar!
                  </p>
                )}
              </div>
            )}
