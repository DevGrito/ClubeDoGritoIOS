...
export const dadosMensais2025 = {
  criancasAtendidas: [null, 330, 305, 305, 318, 284, 328, 321, 333, 370, null, null], // ESTOQUE (snapshot) - último: out (370)
  alunosFormados: [null, null, 72, null, 62, 176, 64, 33, 52, 122, null, null], // FLUXO (mensal) - Total out: 581
  alunosEmFormacao: [57, 71, 80, 30, 211, 204, 170, 162, 341, 255, null, null], // ESTOQUE (snapshot) - último: out (255)
  frequencia: [null, 78, 81, 88, 86, 86, 90, 82, 87, 84, null, null], // ESTOQUE (% snapshot) - último: 84% (out)
  ...
  evasao: [null, 0, 32, 0, 0, 1, 1, 23, 4, 6, null, null], // FLUXO (mensal) - Total out: 67
  geracaoRenda: [null, 1, 21, 8, 45, 10, 13, null, 20, 13, null, null], // FLUXO (mensal) - Total out: 131
  familiasAcompanhadas: [238, 219, 219, 217, 217, 217, 217, 218, 219, 219, null, null], // ESTOQUE (snapshot) - último: 219 (out)
  visitasDomicilio: [323, 297, 332, 363, 398, 407, 354, 387, 313, 366, null, null], // FLUXO (mensal) - Total out: 3540
  atendimentosPsico: [0, 17, 50, 44, 56, 30, 35, 30, 62, 53, null, null] // FLUXO (mensal) - Total out: 377
};
